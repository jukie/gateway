...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LocalServiceCluster) DeepCopyInto(out *LocalServiceCluster) {
	*out = *in
	if in.Destination != nil {
		in, out := &in.Destination, &out.Destination
		*out = new(DestinationSetting)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalServiceCluster.
func (in *LocalServiceCluster) DeepCopy() *LocalServiceCluster {
	if in == nil {
		return nil
	}
	out := new(LocalServiceCluster)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Xds) DeepCopyInto(out *Xds) {
	*out = *in
	...
	if in.LocalServiceCluster != nil {
		in, out := &in.LocalServiceCluster, &out.LocalServiceCluster
		*out = new(LocalServiceCluster)
		(*in).DeepCopyInto(*out)
	}
}
