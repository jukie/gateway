...
func (in *ConsistentHash) DeepCopyInto(out *ConsistentHash) {
	*out = *in
	...
	if in.WeightedZoneConfig != nil {
		in, out := &in.WeightedZoneConfig, &out.WeightedZoneConfig
		*out = new(v1alpha1.WeightedZoneConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *LeastRequest) DeepCopyInto(out *LeastRequest) {
	*out = *in
	...
	if in.RequestDistribution != nil {
		in, out := &in.RequestDistribution, &out.RequestDistribution
		*out = new(v1alpha1.RequestDistribution)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxyInfraCluster) DeepCopyInto(out *ProxyInfraCluster) {
	*out = *in
	if in.Destination != nil {
		in, out := &in.Destination, &out.Destination
		*out = new(DestinationSetting)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxyInfraCluster.
func (in *ProxyInfraCluster) DeepCopy() *ProxyInfraCluster {
	if in == nil {
		return nil
	}
	out := new(ProxyInfraCluster)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Xds) DeepCopyInto(out *Xds) {
	*out = *in
	...
	if in.ProxyInfraCluster != nil {
		in, out := &in.ProxyInfraCluster, &out.ProxyInfraCluster
		*out = new(ProxyInfraCluster)
		(*in).DeepCopyInto(*out)
	}
}
